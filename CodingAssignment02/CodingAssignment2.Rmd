...
# Regression equation
model <- lm(Charges ~ Age + BMI + Children + Female + Smoker + WinterSprings + WinterPark + Oviedo - 1, data = insurance)
...
Age, BMI, Children, Smoker, and WinterPark all tested significant.
